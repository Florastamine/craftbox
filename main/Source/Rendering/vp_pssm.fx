 ...
 //float fLightDepth, float2 vTexCoord)
{
    ...
    fSamples[0] = (tex2D(sMap,vShadowTexCoord.xy).x + fBias < vShadowTexCoord.z) ? 0.0f: 1.0f;  
    fSamples[1] = (tex2D(sMap,vShadowTexCoord.xy + float2(1.0/pssm_res_var,0)).x + fBias < vShadowTexCoord.z) ? 0.0f: 1.0f;  
    fSamples[2] = (tex2D(sMap,vShadowTexCoord.xy + float2(0,1.0/pssm_res_var)).x + fBias < vShadowTexCoord.z) ? 0.0f: 1.0f;  
    fSamples[3] = (tex2D(sMap,vShadowTexCoord.xy + float2(1.0/pssm_res_var,1.0/pssm_res_var)).x + fBias < vShadowTexCoord.z) ? 0.0f: 1.0f;  
