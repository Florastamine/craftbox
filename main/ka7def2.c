var def_dfps,def_dtps,def_dtlv,def_dtcs,def_dtac,def_dtrf,_log,def_dsnd;
ANGLE def_cang;
...
TEXT* def_ctxt = { string("[ OSGP Console Board ] [ka7def2.c]#","#80"); layer = 999; }
...
void def_startup()  // x + _startup
{
	if(_log != NULL) file_str_write(_log," [Entry point from ka7def2.c]  ");
